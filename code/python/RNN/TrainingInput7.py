...
xk=pd.read_csv('data7\data_czk.csv',encoding='latin1')
lyf=pd.read_csv('data7\data_lyf.csv',encoding='latin1')
czk=pd.read_csv('data7\data_xk.csv',encoding='latin1')
...
with tf.Session() as sess:
    ...
    for jj in range(10000):
        ...
        if jj%1000==0:
            print('TrainingTime:')
            print(jj)
    saver.save(sess, "./model7.ckpt")
with tf.Session() as sessss:
    saver.restore(sessss, "./model7.ckpt")
