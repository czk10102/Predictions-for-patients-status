...
qj=pd.read_csv('data6\data_qj.csv',encoding='latin1')
xk=pd.read_csv('data6\data_txr.csv',encoding='latin1')
lyf=pd.read_csv('data6\data_lyf.csv',encoding='latin1')
czk=pd.read_csv('data6\data_czk.csv',encoding='latin1')
cl=pd.read_csv('data6\data_cl.csv',encoding='latin1')
yyh=pd.read_csv('data6\data_yyh.csv',encoding='latin1')
db=pd.read_csv('data6\data_db.csv',encoding='latin1')
gwc=pd.read_csv('data6\data_gwc.csv',encoding='latin1')
syp=pd.read_csv('data6\data_syp.csv',encoding='latin1')
txr=pd.read_csv('data6\data_xk.csv',encoding='latin1')
cjq=pd.read_csv('data6\data_cjq.csv',encoding='latin1')
yyt=pd.read_csv('data6\data_yyt.csv',encoding='latin1')
...
with tf.Session() as sessss:
    saver.restore(sessss, "./model6.ckpt")
